...
{
    /// <summary>
    /// A single editable parameter (name/description/value/category) backing the WPF
    /// ParametersControl. Ported from SAM.Core.Windows.CustomParameter as part of retiring
    /// the SAM_Windows dependency; this is WinForms-free (the PropertyGrid descriptor that
    /// previously wrapped it is not needed by the WPF DataGrid).
    /// </summary>
