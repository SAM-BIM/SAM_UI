...
{
    /// <summary>WPF port of the WinForms RoomProcessControl (start + computed room air conditions).</summary>
    public partial class RoomProcessControl : UserControl, IMollierProcessControl
    {
        ...
        public RoomProcessControl()
        {
            ...
            mollierPointControl_Room.IsEnabled = false;
        ...
        public UIMollierProcess GetUIMollierProcess()
        {
            ...
            return new UIMollierProcess(roomProcess, SystemColor.Empty);
        }
        ...
        {
            get { return mollierPointControl_Room.MollierPoint; }
            set { mollierPointControl_Room.MollierPoint = value; }
        }
    }
}
