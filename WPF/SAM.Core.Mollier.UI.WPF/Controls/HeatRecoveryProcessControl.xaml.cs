...
{
    /// <summary>WPF port of the WinForms HeatRecoveryProcessControl (supply + return points).</summary>
    public partial class HeatRecoveryProcessControl : UserControl, IMollierProcessControl
    {
        ...
        {
            get { return MollierPointControl_Supply.MollierPoint; }
            set { MollierPointControl_Supply.MollierPoint = value; }
        }

        public MollierPoint Return
        {
            get { return MollierPointControl_Return.MollierPoint; }
            set { MollierPointControl_Return.MollierPoint = value; }
        }
