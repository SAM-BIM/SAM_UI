    ...
    public static partial class Convert
    {
        ...
        public static List<Element3D> ToElement3Ds(this GeometryObjectModel geometryObjectModel)
        {
            ...
            if (logEnabled)
            {
                ...
                SharpDXSceneBuilder.ResetOctreeStats();
            ...
            if (logEnabled)
            {
                ...
                // Append includes triangulation (reported separately) + per-bucket position/index copy;
                // Build is the GPU geometry + material construction, of which Octree is the picking tree.
                ...
                PerformanceLog.Write("ViewportControl.ToElement3D.Build.Octree", detail, SharpDXSceneBuilder.OctreeMilliseconds);
            }
